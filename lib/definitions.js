...
iterate(ItemIDs, Items, 'Item', item => ((obj, count, data = {}) => (data.count=count|0,data.name = data.name||'',Object.setPrototypeOf(data, obj))).bind(undefined, item))
iterate(EntityIDs, Entities, 'Entities', entity => (data = {}) => {
	data.tx = data.x = data.x || 0
	data.ty = data.y = data.y || 0
	data.dx = data.dx || 0
	data.dy = data.dy || 0
