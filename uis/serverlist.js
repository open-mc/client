...
drawSkin()
let list, selectSkinBtn, logoutBtn, addRow, nameLabel, modBtn, input = Input('text', texts.serverlist.add_server.placeholder())
input.on('keypress', e => {
...
modBtn.classList.add('selectable')
modBtn.onclick = () => (click(),mods())
